...
train = []
train_labels = []
files = glob.glob ("/home/szilvasi/Documents/Dissertation/DissertationSource/Codes/train1/00/*.jpg")
for myFile in files:
    image = cv2.imread (myFile)
    train.append (image)
    train_labels.append([1., 0., 0., 0., 0.])

files = glob.glob ("/home/szilvasi/Documents/Dissertation/DissertationSource/Codes/train1/01/*.jpg")
for myFile in files:
    image = cv2.imread (myFile)
    train.append (image)
    train_labels.append([0., 1., 0., 0., 0.])

files = glob.glob ("/home/szilvasi/Documents/Dissertation/DissertationSource/Codes/train1/02/*.jpg")
for myFile in files:
    image = cv2.imread (myFile)
    train.append (image)
    train_labels.append([0., 0., 1., 0., 0.])

files = glob.glob ("/home/szilvasi/Documents/Dissertation/DissertationSource/Codes/train1/03/*.jpg")
for myFile in files:
    image = cv2.imread (myFile)
    train.append (image)
    train_labels.append([0., 0., 0., 1., 0.])

files = glob.glob ("/home/szilvasi/Documents/Dissertation/DissertationSource/Codes/train1/04/*.jpg")
for myFile in files:
    image = cv2.imread (myFile)
    train.append (image)
